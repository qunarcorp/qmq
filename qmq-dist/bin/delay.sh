...
JAVA_OPTS="${JAVA_OPTS} -DQMQ_LOG_DIR=${QMQ_LOG_DIR} -Xloggc:${QMQ_LOG_DIR}/delay-gc-${TIMESTAMP}.log -XX:+PrintGC -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=${QMQ_LOG_DIR}"

...
public class PartitionInfo {
    ...
    private Map<Integer, String> physicalPartition2Broker; // 物理分区与 broker 的映射
    private Map<Integer, String> physicalPartition2DelayBroker; // 物理分区与 delay broker 的映射
    private int version;
    ...
    public Map<Integer, String> getPhysicalPartition2Broker() {
        return physicalPartition2Broker;
    }

    public PartitionInfo setPhysicalPartition2Broker(Map<Integer, String> physicalPartition2Broker) {
        this.physicalPartition2Broker = physicalPartition2Broker;
        return this;
    }

    public Map<Integer, String> getPhysicalPartition2DelayBroker() {
        return physicalPartition2DelayBroker;
    }

    public PartitionInfo setPhysicalPartition2DelayBroker(Map<Integer, String> physicalPartition2DelayBroker) {

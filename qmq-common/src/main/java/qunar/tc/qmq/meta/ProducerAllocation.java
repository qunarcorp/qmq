...
public class ProducerAllocation implements Versionable {
     ...
     */
    private RangeMap<Integer, SubjectLocation> logical2SubjectLocation;

    public ProducerAllocation(String subject, int version, RangeMap<Integer, SubjectLocation> logical2SubjectLocation) {
    ...
    public RangeMap<Integer, SubjectLocation> getLogical2SubjectLocation() {

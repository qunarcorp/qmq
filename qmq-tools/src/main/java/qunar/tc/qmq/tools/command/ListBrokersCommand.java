 ...
 * @since 2018-12-05
 */
@Command(name = "ListBrokers", mixinStandardHelpOptions = true, sortOptions = false)
public class ListBrokersCommand implements Runnable {
    ...
    @Option(names = {"--brokerGroup"})
    private String brokerGroup;

    public ListBrokersCommand(final MetaManagementService service) {
    ...
    public void run() {
        ...
        params.put("action", "ListBrokers");
        params.put("brokerGroup", brokerGroup == null ? "" : brokerGroup);

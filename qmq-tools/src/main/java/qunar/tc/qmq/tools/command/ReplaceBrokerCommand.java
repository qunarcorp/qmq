 ...
 * @since 2018-12-05
 */
@Command(name = "ReplaceBroker", mixinStandardHelpOptions = true, sortOptions = false)
public class ReplaceBrokerCommand implements Runnable {
    ...
    public ReplaceBrokerCommand(final MetaManagementService service) {
    ...
    public void run() {
        ...
        params.put("action", "ReplaceBroker");

 ...
 * @since 2018-12-05
 */
@Command(name = "ListBrokerGroups", mixinStandardHelpOptions = true, sortOptions = false)
public class ListBrokerGroupsCommand implements Runnable {
    ...
    public ListBrokerGroupsCommand(final MetaManagementService service) {
    ...
    public void run() {
        ...
        params.put("action", "ListBrokerGroups");

...
namespace Qunar.TC.Qmq.Client.Util
{
    ...
    internal class ConcurrentPriorityQueue<TValue> :
        IProducerConsumerCollection<TValue>
        where TValue : IComparable<TValue>
    {
        ...
        public ConcurrentPriorityQueue(IEnumerable<TValue> collection)
        {
        ...
        public TValue[] ToArray()
        {
            lock (_syncLock)
            {
                ...
                var result = new TValue[_minHeap.Count];
        ...
        private sealed class MinBinaryHeap
        {
            ...
            {
                Items = new List<TValue>(heapToCopy.Items);
            }

            /// <summary>Gets the number of objects stored in the heap.</summary>
            public int Count => Items.Count;

            internal List<TValue> Items { get; }
